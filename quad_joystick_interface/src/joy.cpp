...
Joy::Joy() {
  ...
  trajectory_msg.snap.x = 0.0;	// takeoff A
  trajectory_msg.snap.y = 0.0;	// land X
  trajectory_msg.jerk.x = 0.0;	// enable GPS B
  trajectory_msg.jerk.y = 0.0;	// enable mission Y
...
//std::cout << control_msg_.yaw_rate << " : "<< axes_.yaw<< " "<< max_.rate_yaw <<std::endl;
